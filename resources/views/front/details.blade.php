        ...
        <header class="relative h-[480px] mb-[44px]">
            ...
            <div class="swiper-gallery w-full overflow-hidden">
                <div class="swiper-wrapper">
                    @forelse ($ticket->photos as $photo)
                        <div class="swiper-slide">
                            <div class="relative flex items-center w-full h-[480px] shrink-0 bg-[#13181D] overflow-hidden">
                                <img src="{{Storage::url($photo->photo)}}" class="absolute w-full h-full object-cover" alt="thumbnail">
                            </div>
                        </div>
                    @empty
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">{{$ticket->open_at_time}}</p>
                        </div>
                    </div>
                    <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                        ...
                        <div class="text-left">
                            ...
                            <p class="font-bold text-lg leading-[27px]">{{$ticket->closed_at_time}}</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                    <div class="flex items-center gap-[14px]">
                        ...
                        <div>
                            ...
                            <p class="text-sm leading-[21px]">183,409 Places</p>
                        </div>
                    </div>
                    <a href="#">
