                    ...
                    <div class="swiper-wrapper">
                        @forelse ($popularTickets as $popularTicket)
                            <div class="swiper-slide !w-fit">
                                <a href="{{url('/details/'. $popularTicket->slug)}}" class="card">
                                    ...
                                    <div class="relative flex items-end w-[170px] h-[200px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                        ...
                                        <div class="flex items-center justify-between w-full h-fit rounded-[17px] border border-white/40 p-[8px_10px] mx-[10px] mb-[10px] bg-[#94959966] backdrop-blur-sm">
                                            <div>
                                                ...
                                                <p class="text-sm leading-[18px] text-white">{{$seller->location}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="flex items-center gap-[14px]">
                                    ...
                                    <div class="flex flex-col gap-[6px]">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <p class="font-semibold text-xs leading-[18px]">{{$newTicket->location}}</p>
                                        </div>
                                        <p class="font-bold text-sm leading-[21px] text-[#F97316]">Rp. {{number_format($newTicket->price, 0, '.', '.')}}</p>
                                    </div>
                                </div>
            ...
            <ul class="flex justify-evenly max-[400px]:justify-between">
                ...
                <li class=" text-[#13181D]">
                    <a href="check-booking.html" class="menu">
                        <div class="group flex flex-col items-center text-center gap-[10px]">
                            <div class="w-6 h-6 flex shrink-0">
                                <svg class="transition-all duration-300 group-hover:fill-[#F97316]  fill-current" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000">
